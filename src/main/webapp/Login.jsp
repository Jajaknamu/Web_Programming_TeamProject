			            ...
			            <div class="row">
			                <div class="col-md-6 login-form-1">
			                    ...
			                    <form method="post" action="LoginAction.jsp">
			                        <div class="form-group">
			                            <input type="text" class="form-control" placeholder="학번/교번" name="userID" />
			                        </div>
			                        <div class="form-group">
			                ...
			                <div class="col-md-6 login-form-2">
			                    ...
			                    <form method="post" action="JoinAction.jsp">
			                        <div class="form-group">
			                            <input type="text" class="form-control" placeholder="학교이름" name="school" />
			                        </div>
			                        <div class="form-group">
			                            <input type="text" class="form-control" placeholder="학번/교번" name="userID" />
			                        </div>
			                        <div class="form-group">
			                            <input type="password" class="form-control" placeholder="사용할 비밀번호" name="userPassword" />
			                        </div>
			                        <div class="form-group">
